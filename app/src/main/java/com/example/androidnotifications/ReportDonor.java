...
public class ReportDonor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DonorEmail =  findViewById(R.id.edt_name);
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Report record = new Report(donorEmail,receiverEmail,donationDate);
                DatabaseReference myRef = database.getReference("reported_donors");

                if (donorEmail.isEmpty() || donationDate.isEmpty() ) {

                    AlertDialog.Builder builder = new AlertDialog.Builder(ReportDonor.this);

...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
     ...
     /*   LatLng you = new LatLng(Main2Activity.lat, Main2Activity.lng);
        ...
        for(int i=0; i<DonorListActivity.list.size(); i++){
            Log.d("Donor", String.valueOf(i));


            Donor donor = DonorListActivity.list.get(i);
            ...
            if (donor.getPhonePrivacy().equals("1")){
                donor.contuctNumber="";
            }
            ...
            if (donor.getAvailability().equals("1") && donor.getLocationPrivacy().equals("0")){

                if (donor.getPhonePrivacy().equals("0")){
